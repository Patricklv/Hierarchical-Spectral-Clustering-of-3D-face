function LabelTotal=HierarchicalSegmentationUsingSpectralClustering(SimilarityMatrix,n_levels,type,runs)
...
%   'k' - Number of clusters to look for, fixed to 2 in this implementation
